          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-6 py-12 sm:px-8 sm:py-16 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-12 lg:px-10 lg:py-[60px]">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center lg:flex-col lg:items-stretch lg:justify-end">
              {item.secondaryButtonText ? (
                <>
                  <Link
                    href={item.secondaryButtonHref || "/estimate"}
                    className="inline-flex items-center justify-center gap-2 rounded bg-teal px-4 py-2.5 text-sm font-bold uppercase tracking-wide text-white transition-colors hover:bg-blue hover:text-white lg:min-w-[220px] lg:px-6 lg:py-3.5"
                  >
                    {item.secondaryButtonText}
                    <ArrowIcon />
                  </Link>
